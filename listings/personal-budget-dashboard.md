...
Budget Template Excel & Google Sheets — Annual + Monthly Budget Spreadsheet with Savings Goals, Debt Payoff & Bill Tracker

**Suggested price:** $12 (launch price $9 for the first two weeks)

**One-liner (Gumroad summary field):**
Monthly budget vs. actual, a year-at-a-glance heatmap, savings goal math, debt payoff dates, and a bill tracker — one file that shows exactly where your money goes.
...
- 💳 **Debt Payoff** — enter balance, APR, and payment for each debt: see months to payoff, your debt-free date, and total interest — plus what one extra payment per month saves you (avalanche method)
